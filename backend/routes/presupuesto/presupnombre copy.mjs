...
// La ruta donde grabas tus archivos (usa una variable de entorno o path.join)
const RUTA_PDFS = path.join(__dirname, caminoynombrearch);

// Haces que esa carpeta sea accesible vía URL
app.use('/ver-pdf', express.static(RUTA_PDFS));
