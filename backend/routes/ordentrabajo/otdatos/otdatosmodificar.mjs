...
router.post("/", async (req, res) => {
  ...
  // const OTDatosOpciones = JSON.stringify(req.body.OTDatosOpciones);
  ...
  conexionpool.query(q, [OTDatosDesc, OTDatosTipoPed, OTDatosRequerido, OTDatosOrdenAparicion, OTDatosAncho, idOTDatos], (err, result) => {
    if (err) {
      if (err.errno == 1062) {
