...
const menuItems = [
    ...
    subItems: [
      {
        name: 'Electrónicos',
        subItems: [
          { name: 'Smartphones', subItems: [] },
          { name: 'Laptops', subItems: [] },
          { name: 'Tablets', subItems: [] },
        ],
      },
      {
        name: 'Ropa',
        subItems: [
          { name: 'Hombre', subItems: [] },
          { name: 'Mujer', subItems: [] },
          { name: 'Niños', subItems: [] },
        ],
      },
  ...
  },
  {
	...
	path :"/",
    subItems: [
      { name: 'Presupuestos', component:{Link},
	  to:"/PresupPant", subItems: [] },
      { name: 'Desarrollo', subItems: [] },
      { name: 'Diseño', subItems: [] },
    ],
  },
  {
    name: 'Acerca de',
...
// Componente recursivo para renderizar menús y submenús
const MenuItems = ({ items, depth = 0 }) => {
        ...
        <React.Fragment key={item.name}>
          ...
          {item.subItems.length > 0 && (
            <Collapse in={openItems[item.name]} timeout="auto" unmountOnExit>
              <MenuItems items={item.subItems} depth={depth + 1} />
            </Collapse>
          )}
        </React.Fragment>
      ))}
