...
const App = () => {
  ...
  function DashboardLayoutBasic(props) {
    ...
    const router = useDemoRouter('/ListaPrecios');
  ...
  //   const [openSubMenuTPB, setOpenSubMenuTPB] = useState(false);
  ...
  //   const handleSubMenuTPB = () => {
  //     setOpenSubMenuTPB(!openSubMenuTPB);
  //   };
