...
export default function FilaAnexo(props) {
	...
	function sumar() {
		...
		let importetotal2 = importetotal.toFixed(2)
		setSumaAnexo(importetotal2);
	...
	async function handleChange(event) {
		...
		const datoincial = {
			...
			AnexoMedida: 1,
			importea: Number(datosrenglon1[0].ImpUnitario),
			PresupConfTipoImprime: datosrenglon1[0].ImprimeSN
			,
			importet: Number(datosrenglon1[0].ImpUnitario)
