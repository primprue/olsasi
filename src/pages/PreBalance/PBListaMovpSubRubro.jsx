...
export async function PBListaMovpSubRubro(fechaDesde, fechaHasta, ejecutorbackend) {
    const url = `${IpServidor}/${ejecutorbackend}/?fechaDesde=${fechaDesde}&fechaHasta=${fechaHasta}`;
    swal({
        title: "Aguarde",
